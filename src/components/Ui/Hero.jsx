        ...
        <div className="items-center justify-between md:flex sm:flex-col md:flex-row">
          <div className="w-full md:basis-1/2">
            ...
            >
              ...
              <a
                href="#portfolio"
                className="text-lg text-[#193256] font-[600] text-[16px] border-b border-solid border-[#193256]"
              >
                See portfolio
              </a>
            </div>
            <p
              data-aos="fade-left"
              data-aos-duration="1500"
              className="text-lg flex gap-2 text-[#081e21] mt-14 font-[500] text-[15px] leading-7 sm:pl-14 sm:pr-10"
            >
              <span>
            ...
            <div className="flex items-center gap-9 mt-14">
              <span className=" text-xl text-[#193256] text-[15px] font-[600]">
                Follow me:
              </span>
              <span>
                <a
                  href="https://github.com/Hrithik100"
                  className="text-[#193256] text-[30px] font-[600]"
                >
